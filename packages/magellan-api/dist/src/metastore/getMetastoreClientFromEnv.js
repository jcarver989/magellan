...
exports.getMetastoreClientFromEnv = void 0;
const AwsGlueClient_1 = require("./AwsGlueClient");
var MetastoreClientName;
(function (MetastoreClientName) {
    MetastoreClientName["GLUE"] = "aws-glue";
})(MetastoreClientName || (MetastoreClientName = {}));
 ...
 */
function getMetastoreClientFromEnv() {
    switch (process.env.METASTORE_CLIENT) {
        case MetastoreClientName.GLUE:
        case undefined: {
            return new AwsGlueClient_1.AwsGlueClient();
        }
        default: {
            throw new Error(`process.env.METASTORE_CLIENT is set to: ${process.env.METASTORE_CLIENT}, which is not a supported metastore client name`);
        }
    }
}
exports.getMetastoreClientFromEnv = getMetastoreClientFromEnv;
